...
class LineChartController : UITableViewController, ANDLineChartViewDataSource, ANDLineChartViewDelegate {
    ...
    override func viewDidLoad() {
        ...
        lineChartView.gridIntervalFont = UIFont(name: MegaTheme.semiBoldFontName, size: 13)
        ...
        webLabel.font = UIFont(name: MegaTheme.semiBoldFontName, size: 16)
        webLabel.textColor = UIColor(white: 0.48, alpha: 1.0)
        
        webValue.text = "$20,443"
        webValue.font = UIFont(name: MegaTheme.semiBoldFontName, size: 30)
        webValue.textColor = UIColor.blackColor()
        
        bankLabel.text = "BANK FEES"
        bankLabel.font = UIFont(name: MegaTheme.semiBoldFontName, size: 16)
        bankLabel.textColor = UIColor(white: 0.48, alpha: 1.0)
        
        bankValue.text = "$14,211"
        bankValue.font = UIFont(name: MegaTheme.semiBoldFontName, size: 30)
        bankValue.textColor = UIColor.blackColor()
        
        rentLabel.text = "RENT"
        rentLabel.font = UIFont(name: MegaTheme.semiBoldFontName, size: 16)
        rentLabel.textColor = UIColor(white: 0.48, alpha: 1.0)
        
        rentValue.text = "40%"
        rentValue.font = UIFont(name: MegaTheme.semiBoldFontName, size: 30)
        rentValue.textColor = UIColor.blackColor()
        
        revenueLabel.text = "REVENUE"
        revenueLabel.font = UIFont(name: MegaTheme.semiBoldFontName, size: 16)
        revenueLabel.textColor = UIColor(white: 0.48, alpha: 1.0)
        
        revenueValue.text = "+150%"
        revenueValue.font = UIFont(name: MegaTheme.semiBoldFontName, size: 30)
        ...
        refreshButton.titleLabel?.font = UIFont(name: MegaTheme.boldFontName, size: 25)!
